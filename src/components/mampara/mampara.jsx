...
export default function Component2() {
  ...
  //extrusores
  const [etiquetasEnExtrusores, setEtiquetasEnExtrusores] = useState({
    "EXT54-II": [],
    "BUSS I": [],
    "EXT70-II": [],
    // Agrega otros extrusores aquí
  });

  const handleTagAdd = (tag, extrusor) => {
    // Agrega la etiqueta al extrusor en el estado local
    setEtiquetasEnExtrusores({
      ...etiquetasEnExtrusores,
      [extrusor]: [...etiquetasEnExtrusores[extrusor], tag],
    });
  };
