...
const EtiquetaTable54_4 = ({ etiquetas54_4, setEtiquetas54_4 }) => {
  ...
  const handleExtrudeEtiqueta = async (etiquetaId) => {
    try {
      ...
      // Filtrar etiquetas54_4 eliminando la etiqueta
      const updatedEtiquetas54_4 = etiquetas54_4.filter(
        (item) => item.id !== etiquetaId
      );
      setEtiquetas54_4(updatedEtiquetas54_4);

      // Guardar las etiquetas actualizadas en la API
      await axios.post(apiUrlEtiquetasExt54_4, updatedEtiquetas54_4);
  ...
  return (
    <div className="position etiquetasAgregadas">
      <h6 className="text-center tittleEtiquetas">Ext 54 IV</h6>
      {loading ? (
