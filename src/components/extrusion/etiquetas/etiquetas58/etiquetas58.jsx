...
const EtiquetaTable58 = () => {
    ...
    if (watchExt58 !== null) {
      ...
      if (orderChanged) {
        const guardarEtiquetas58Masivo = async () => {
          try {
            const etiquetasConExtrusores = etiquetas58.map(
              (etiqueta, index) => ({
                ...etiqueta,
                extrusor: "EXT-58",
            ...
            await axios.post(apiUrlEtiquetasExt58, etiquetasConExtrusores);
            ...
            await localforage.setItem("etiquetas58", etiquetasConExtrusores);
  ...
  }, [etiquetas58, originalOrder, watchExt58]);
